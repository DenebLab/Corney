...
namespace Corney.Common.Infrastructure
{
    /// <summary>
    ...
    public static class AttemptExtensions
    {
        ...
        /// <param name="message">
        /// The message used when throwing a <see cref="RepeatedFailureException" /> after all attempts have
        /// failed.
        /// </param>
        /// <param name="maxRetainedAttempts">
        /// The max number of attempts to return on success or to include when throwing a
        /// <see cref="RepeatedFailureException" /> after all attempts have failed.
        /// </param>
        ...
        /// Gets the value of the first successful attempt or the default value.
        /// </summary>
        public static async Task<T> GetValueOrDefaultAsync<T>(this IEnumerable<Task<Attempt<T>>> attempts)
        {
            var value = default(T);
        ...
        /// </summary>
        /// <param name="maxReturnAttempts">
        /// The maximum number of attempts to return. When specified only the most recent attempts
        /// will be returned.
        /// </param>
        ...
        /// </param>
        /// <returns>An array of the attempts.</returns>
        public static async Task<Attempts<T>> ExecuteAsync<T>(this IEnumerable<Lazy<Task<T>>> lazyAttempts,
            int? maxReturnAttempts = null)
            where T : Attempt
        {
            var attempts = new Attempts<T> {Capacity = maxReturnAttempts};
